...
class ComponentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('components')->insert([
            'name' => 'ドロマイト',
            'effect' => 'ドロマイトは日本では「苦灰石」とよばれる天然の鉱物。主成分は炭酸カルシウムと炭酸マグネシウムです。ドロマイトは、石灰石が取れる山のふもとであれば、世界中どこでも採取することができます。日本でも北海道から沖縄までどこでも取れますが、栃木県佐野市で多く採掘されているようです。天然の鉱物であるドロマイトには、鉛・カドミウム・水銀などの人体に有害な重金属が含まれている可能性があります。',
            'created_at' => new DateTime(),
            'updated_at' => new DateTime(),
        ]);
