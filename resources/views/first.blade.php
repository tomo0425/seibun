        ...
        <div class="container " style="margin-top:200px;">
            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-md-6 text-right" style="padding-right:50px;">
                    <button type="button" class="btn btn-primary" style="font-size: 24px; padding: 12px 24px;" >ログイン</button>
                </div>
                <div class="col-md-6 text-left" style="padding-left:50px;">
                    <button type="button" class="btn btn-primary" style="font-size: 24px; padding: 12px 24px;">登録する</button>
                </div>
            </div>
        </div>    
